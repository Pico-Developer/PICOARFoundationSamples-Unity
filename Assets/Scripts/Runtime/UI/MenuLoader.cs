...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class MenuLoader : MonoBehaviour
    {
        ...
        const string k_PICOMenuScene = "PICOMenu";
        ...
        public static string GetMenuSceneName()
        {
            ...
            {
                case "PXR_SessionSubsystem":
                    return k_PICOMenuScene;
                case "Meta-Session":
        ...
        public static bool IsHmdDevice()
        {
            ...
            return (sceneName == k_MetaMenuScene) || (sceneName == k_HololensMenuScene) || (sceneName == k_PICOMenuScene);
        }
